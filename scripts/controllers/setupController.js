        ...
        data: {
            ...
            enemys: 
                    [{name:"Dropphin",   hp:150,    total: 150,         img:"images/enemys/007_dropphin_by_deoxysdaniel-d5j9slu.png"},
                     ...
                     {name:"Firnhorn",   hp:8000,   total: 8000,        img:"images/enemys/046_firnhorn_by_deoxysdaniel-d5o36ot.png"},
                     {name:"Glacyak",    hp:8000,   total: 8000,        img:"images/enemys/047_glacyak_by_deoxysdaniel-d5oh0h6.png"},
                     {name:"Anemo",     hp:18000,   total: 8000,        img:"images/enemys/051_anemo_by_deoxysdaniel-d5nwex0.png"},
                     {name:"Nemonish",  hp:280000,   total: 8000,       img:"images/enemys/052_nemonish_by_deoxysdaniel-d5o375e.png"},
                     {name:"Ancshark",  hp:380000,   total: 8000,       img:"images/enemys/056_ancshark_by_deoxysdaniel-d5p8brn.png"},
                     {name:"Ankammer",  hp:4800000,   total: 8000,      img:"images/enemys/057_ankammer_by_deoxysdaniel-d5p8ici.png"},
                     {name:"Hammerank",  hp:5800000,   total: 8000,     img:"images/enemys/058_hammerank_by_deoxysdaniel-d5p9sfq.png"},
                     {name:"Leafllen",  hp:6800000,   total: 8000,      img:"images/enemys/059_leafllen_by_deoxysdaniel-d5pg65m.png"},
                     {name:"Spectree",  hp:7800000,   total: 8000,      img:"images/enemys/060_spectree_by_deoxysdaniel-d5pg6nk.png"},
                     {name:"Treethom",  hp:8800000,   total: 8000,      img:"images/enemys/061_treethom_by_deoxysdaniel-d5pg7k8.png"},
                     {name:"Macombu",  hp:98000000,   total: 8000,      img:"images/enemys/062_macombu_by_deoxysdaniel-d5pmg6t.png"},
                     {name:"Eumovolt",  hp:10800000,   total: 8000,     img:"images/enemys/063_eumovolt_by_deoxysdaniel-d5pmg70.png"},
                     {name:"Spookola",  hp:118000000,   total: 8000,    img:"images/enemys/064_____by_deoxysdaniel-d5pqlrv.png"},
                     {name:"Bookola",  hp:1280000000,   total: 8000,    img:"images/enemys/065_____by_deoxysdaniel-d5psbvj.png"},
                     {name:"Sparkle",  hp:1380000000,   total: 8000,    img:"images/enemys/066_____by_deoxysdaniel-d5pqls8.png"},
                     {name:"The Don",  hp:1480000000,   total: 8000,    img:"images/enemys/067_____by_deoxysdaniel-d5psbvs.png"},
                     {name:"Zenkqwaak",  hp:1580000000,   total: 8000,                  img:"images/enemys/068_last_fakemon_of_the_year_by_deoxysdaniel-d5px255.png"},
                     {name:"Tribuno",  hp:1680000000,   total: 8000,                    img:"images/enemys/069_tribuno_by_deoxysdaniel-d5q5kzq.png"},
                     {name:"Tributoo",  hp:1780000000,   total: 8000,                   img:"images/enemys/070_tributoo_by_deoxysdaniel-d5q7s8m.png"},
                     {name:"Tycub",  hp:1880000000,   total: 8000,                      img:"images/enemys/071_tycub_by_deoxysdaniel-d5qbho6.png"},
                     {name:"Lycub",  hp:9007199254,   total: 8000,                      img:"images/enemys/072_lycub_by_deoxysdaniel-d5quelj.png"},
                     {name:"Lycantrix",  hp:9997199254,   total: 8000,                  img:"images/enemys/073_____by_deoxysdaniel-d5r6whv.png"},
                     {name:"Companyan",  hp:9997199254,   total: 9997199254,            img:"images/enemys/074_companyan_by_deoxysdaniel-d5quelr.png"},
                     {name:"Felomnious",  hp:90071992547,   total: 90071992547,         img:"images/enemys/075_felomnious_by_deoxysdaniel-d5r55wu.png"},
                     {name:"Lumbrunnel",  hp:900719925474,   total: 900719925474,       img:"images/enemys/076_lumbrunnel_by_deoxysdaniel-d5qzbiv.png"},
                     {name:"Unidirecto",  hp:9007199254740,   total: 9007199254740,     img:"images/enemys/077_____by_deoxysdaniel-d5r6wim.png"},
                     {name:"Chemiost",  hp:90071992547409,   total: 90071992547409,     img:"images/enemys/078_chemiost_by_deoxysdaniel-d5qzbj9.png"},
                     {name:"Chemizomb",  hp:90071992547409,   total: 900719925474099,   img:"images/enemys/079_chemizomb_by_deoxysdaniel-d5r55x0.png"},
                     {name:"Sounshock",  hp:90071992547409,   total: 900719925474099,   img:"images/enemys/080_sounshock_by_deoxysdaniel-d5rq3pz.png"},
                     {name:"Metahertz",  hp:90071992547409,   total: 900719925474099,   img:"images/enemys/081_metahertz_by_deoxysdaniel-d5rq3q5.png"},
                     {name:"Decibvolt",  hp:90071992547409,   total: 900719925474099,   img:"images/enemys/082_decibvolt_by_deoxysdaniel-d5rq3qf.png"},
                     {name:"Bilophos",  hp:90071992547409,   total: 900719925474099,    img:"images/enemys/083_bilophos_by_daniel_dna-d5s1icl.png"},
                     {name:"Bilophotor",  hp:90071992547409,   total: 900719925474099,  img:"images/enemys/084_bilophotor_by_daniel_dna-d5shojp.png"},
                     {name:"Dimitron",  hp:90071992547409,   total: 900719925474099,    img:"images/enemys/085_dimitron_by_daniel_dna-d5s1ijl.png"},
                     {name:"Dimetrogos",  hp:900719925474099,   total: 900719925474099, img:"images/enemys/086_dimetrogos_by_daniel_dna-d5t3ep1.png"},
                     {name:"Fragerus",  hp:900719925474099,   total: 900719925474099,   img:"images/enemys/fragerus_by_deoxysdaniel-d5rpwqf.png"},
                     {name:"Gryffigon",  hp:900719925474099,   total: 900719925474099,  img:"images/enemys/gryffigon_by_daniel_dna-d5w8jdr.png"},
                     {name:"Orthivide",  hp:900719925474099,   total: 900719925474099,  img:"images/enemys/orthivide_by_deoxysdaniel-d5rpwqr.png"},
                     {name:"Unihund",  hp:900719925474099,   total: 900719925474099,    img:"images/enemys/unihund_by_deoxysdaniel-d5ru0dg.png"}],
