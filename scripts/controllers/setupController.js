...
app.controller('setupController', function($scope) {
    ...
    $scope.items = [{name:"Harder Bite",  img:"images/items/water.png",                count:0, price:10,     dmg:1,     max:2},
    ...
    $scope.friends = [{name:"Pandoo", count: 1, lvl:1, levelUp: 10, stage:1, dmg:100, img:"images/friends/001_pandoo_by_deoxysdaniel-d5j9po2.png"},
                    {name:"Blazby",   count: 1, lvl:1, levelUp: 10, stage:1, dmg:200, img:"images/friends/004_blazby_by_deoxysdaniel-d5j9qzc.png"},
                    {name:"Kniron",   count: 1, lvl:1, levelUp: 10, stage:1, dmg:300, img:"images/friends/038_kniron_by_deoxysdaniel-d5ncn7r.png"},
