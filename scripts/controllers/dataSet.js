        ...
        data: {
            ...
            enemys: 
                    [{name:"Dropphin",   hp:150, total: 150, power:'easy', index: 1, img:"images/enemys/007_dropphin_by_deoxysdaniel-d5j9slu.png"},
                     ...
                     {name:"Macombu",    hp:0,   total: 0,   power:'medum', img:"images/enemys/062_macombu_by_deoxysdaniel-d5pmg6t.png"},
                     {name:"Eumovolt",   hp:0,   total: 0,   power:'medum', img:"images/enemys/063_eumovolt_by_deoxysdaniel-d5pmg70.png"},
                     {name:"Spookola",   hp:0,   total: 0,   power:'medum', img:"images/enemys/064_____by_deoxysdaniel-d5pqlrv.png"},
                     {name:"Bookola",    hp:0,   total: 0,   power:'medum', img:"images/enemys/065_____by_deoxysdaniel-d5psbvj.png"},
                     {name:"Sparkle",    hp:0,   total: 0,   power:'medum', img:"images/enemys/066_____by_deoxysdaniel-d5pqls8.png"},
                     {name:"The Don",    hp:0,   total: 0,   power:'medum', img:"images/enemys/067_____by_deoxysdaniel-d5psbvs.png"},
                     {name:"Zenkqwaak",  hp:0,   total: 0,   power:'medum', img:"images/enemys/068_last_fakemon_of_the_year_by_deoxysdaniel-d5px255.png"},
                     {name:"Tribuno",    hp:0,   total: 0,   power:'medum', img:"images/enemys/069_tribuno_by_deoxysdaniel-d5q5kzq.png"},
                     {name:"Tributoo",   hp:0,   total: 0,   power:'medum', img:"images/enemys/070_tributoo_by_deoxysdaniel-d5q7s8m.png"},
                     {name:"Tribarrior", hp:0,   total: 0,   power:'medum', img:"images/enemys/071_tribarrior_by_deoxysdaniel-d5qbho6.png"},
                     {name:"Lycub",      hp:0,   total: 0,   power:'hard', img:"images/enemys/072_lycub_by_deoxysdaniel-d5quelj.png"},
                     {name:"Lycantrix",  hp:0,   total: 0,   power:'hard', img:"images/enemys/073_____by_deoxysdaniel-d5r6whv.png"},
                     {name:"Companyan",  hp:0,   total: 0,   power:'hard', img:"images/enemys/074_companyan_by_deoxysdaniel-d5quelr.png"},
                     {name:"Felomnious", hp:0,   total: 0,   power:'hard', img:"images/enemys/075_felomnious_by_deoxysdaniel-d5r55wu.png"},
                     {name:"Lumbrunnel", hp:0,   total: 0,   power:'hard', img:"images/enemys/076_lumbrunnel_by_deoxysdaniel-d5qzbiv.png"},
                     {name:"Unidirecto", hp:0,   total: 0,   power:'hard', img:"images/enemys/077_____by_deoxysdaniel-d5r6wim.png"},
                     {name:"Chemiost",   hp:0,   total: 0,   power:'hard', img:"images/enemys/078_chemiost_by_deoxysdaniel-d5qzbj9.png"},
                     {name:"Chemizomb",  hp:0,   total: 0,   power:'hard', img:"images/enemys/079_chemizomb_by_deoxysdaniel-d5r55x0.png"},
                     {name:"Sounshock",  hp:0,   total: 0,   power:'hard', img:"images/enemys/080_sounshock_by_deoxysdaniel-d5rq3pz.png"},
                     {name:"Metahertz",  hp:0,   total: 0,   power:'hard', img:"images/enemys/081_metahertz_by_deoxysdaniel-d5rq3q5.png"},
                     {name:"Decibvolt",  hp:0,   total: 0,   power:'hard', img:"images/enemys/082_decibvolt_by_deoxysdaniel-d5rq3qf.png"},
                     {name:"Bilophos",   hp:0,   total: 0,   power:'hard', img:"images/enemys/083_bilophos_by_daniel_dna-d5s1icl.png"},
                     {name:"Bilophotor", hp:0,   total: 0,   power:'legendary', img:"images/enemys/084_bilophotor_by_daniel_dna-d5shojp.png"},
                     {name:"Dimitron",   hp:0,   total: 0,   power:'legendary', img:"images/enemys/085_dimitron_by_daniel_dna-d5s1ijl.png"},
                     {name:"Dimetrogos", hp:0,   total: 0,   power:'legendary', img:"images/enemys/086_dimetrogos_by_daniel_dna-d5t3ep1.png"},
                     {name:"Fragerus",   hp:0,   total: 0,   power:'legendary', img:"images/enemys/fragerus_by_deoxysdaniel-d5rpwqf.png"},
                     {name:"Gryffigon",  hp:0,   total: 0,   power:'legendary', img:"images/enemys/gryffigon_by_daniel_dna-d5w8jdr.png"},
                     {name:"Orthivide",  hp:0,   total: 0,   power:'legendary', img:"images/enemys/orthivide_by_deoxysdaniel-d5rpwqr.png"},
